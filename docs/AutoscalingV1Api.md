...
> crate::models::V1HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespace, body, pretty, dry_run, field_manager, field_validation)
...
**body** | [**V1HorizontalPodAutoscaler**](V1HorizontalPodAutoscaler.md) |  | [required] |
...
[**crate::models::V1HorizontalPodAutoscaler**](v1.HorizontalPodAutoscaler.md)
...
> crate::models::V1HorizontalPodAutoscalerList list_horizontal_pod_autoscaler_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1HorizontalPodAutoscalerList**](v1.HorizontalPodAutoscalerList.md)
...
> crate::models::V1HorizontalPodAutoscalerList list_namespaced_horizontal_pod_autoscaler(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
> crate::models::V1HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler(name, namespace, pretty)
...
> crate::models::V1HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler_status(name, namespace, pretty)
...
> crate::models::V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty, dry_run, field_manager, field_validation)
