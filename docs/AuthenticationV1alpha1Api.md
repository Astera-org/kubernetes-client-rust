...
> crate::models::V1alpha1SelfSubjectReview create_self_subject_review(body, dry_run, field_manager, field_validation, pretty)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1SelfSubjectReview**](V1alpha1SelfSubjectReview.md) |  | [required] |
...
[**crate::models::V1alpha1SelfSubjectReview**](v1alpha1.SelfSubjectReview.md)
