...
> crate::models::V1FlowSchema create_flow_schema(body, pretty, dry_run, field_manager, field_validation)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1FlowSchema**](V1FlowSchema.md) |  | [required] |
...
[**crate::models::V1FlowSchema**](v1.FlowSchema.md)
...
> crate::models::V1PriorityLevelConfiguration create_priority_level_configuration(body, pretty, dry_run, field_manager, field_validation)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1PriorityLevelConfiguration**](V1PriorityLevelConfiguration.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
**field_validation** | Option<**String**> | fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered. |  |
...
[**crate::models::V1PriorityLevelConfiguration**](v1.PriorityLevelConfiguration.md)
...
> crate::models::V1FlowSchemaList list_flow_schema(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1FlowSchemaList**](v1.FlowSchemaList.md)
...
> crate::models::V1PriorityLevelConfigurationList list_priority_level_configuration(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1PriorityLevelConfigurationList**](v1.PriorityLevelConfigurationList.md)
...
> crate::models::V1FlowSchema patch_flow_schema(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1FlowSchema patch_flow_schema_status(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1PriorityLevelConfiguration patch_priority_level_configuration(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1PriorityLevelConfiguration patch_priority_level_configuration_status(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1FlowSchema read_flow_schema(name, pretty)
...
> crate::models::V1FlowSchema read_flow_schema_status(name, pretty)
...
> crate::models::V1PriorityLevelConfiguration read_priority_level_configuration(name, pretty)
...
> crate::models::V1PriorityLevelConfiguration read_priority_level_configuration_status(name, pretty)
...
> crate::models::V1FlowSchema replace_flow_schema(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1FlowSchema replace_flow_schema_status(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1PriorityLevelConfiguration replace_priority_level_configuration(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1PriorityLevelConfiguration replace_priority_level_configuration_status(name, body, pretty, dry_run, field_manager, field_validation)
