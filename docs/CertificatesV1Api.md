...
> crate::models::V1CertificateSigningRequest create_certificate_signing_request(body, pretty, dry_run, field_manager, field_validation)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1CertificateSigningRequest**](V1CertificateSigningRequest.md) |  | [required] |
...
[**crate::models::V1CertificateSigningRequest**](v1.CertificateSigningRequest.md)
...
> crate::models::V1Status delete_certificate_signing_request(name, pretty, dry_run, grace_period_seconds, orphan_dependents, propagation_policy, body)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | name of the CertificateSigningRequest | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
...
> crate::models::V1Status delete_collection_certificate_signing_request(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, send_initial_events, timeout_seconds, body)
...
> crate::models::V1CertificateSigningRequestList list_certificate_signing_request(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1CertificateSigningRequestList**](v1.CertificateSigningRequestList.md)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request_status(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1CertificateSigningRequest read_certificate_signing_request(name, pretty)
...
> crate::models::V1CertificateSigningRequest read_certificate_signing_request_approval(name, pretty)
...
> crate::models::V1CertificateSigningRequest read_certificate_signing_request_status(name, pretty)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request_status(name, body, pretty, dry_run, field_manager, field_validation)
