...
> crate::models::V1ApiService create_api_service(body, pretty, dry_run, field_manager, field_validation)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1ApiService**](V1ApiService.md) |  | [required] |
...
[**crate::models::V1ApiService**](v1.APIService.md)
...
> crate::models::V1Status delete_collection_api_service(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, send_initial_events, timeout_seconds, body)
...
> crate::models::V1ApiServiceList list_api_service(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1ApiServiceList**](v1.APIServiceList.md)
...
> crate::models::V1ApiService patch_api_service(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1ApiService patch_api_service_status(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1ApiService read_api_service(name, pretty)
...
> crate::models::V1ApiService read_api_service_status(name, pretty)
...
> crate::models::V1ApiService replace_api_service(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1ApiService replace_api_service_status(name, body, pretty, dry_run, field_manager, field_validation)
