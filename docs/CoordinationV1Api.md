...
> crate::models::V1Lease create_namespaced_lease(namespace, body, pretty, dry_run, field_manager, field_validation)
...
**body** | [**V1Lease**](V1Lease.md) |  | [required] |
...
[**crate::models::V1Lease**](v1.Lease.md)
...
> crate::models::V1Status delete_collection_namespaced_lease(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, send_initial_events, timeout_seconds, body)
...
> crate::models::V1Status delete_namespaced_lease(name, namespace, pretty, dry_run, grace_period_seconds, orphan_dependents, propagation_policy, body)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | name of the Lease | [required] |
**namespace** | **String** | object name and auth scope, such as for teams and projects | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**grace_period_seconds** | Option<**i32**> | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. |  |
...
> crate::models::V1LeaseList list_lease_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1LeaseList**](v1.LeaseList.md)
...
> crate::models::V1LeaseList list_namespaced_lease(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
> crate::models::V1Lease patch_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1Lease read_namespaced_lease(name, namespace, pretty)
...
> crate::models::V1Lease replace_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager, field_validation)
