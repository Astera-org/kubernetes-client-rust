...
> crate::models::V1alpha1StorageVersionMigration create_storage_version_migration(body, pretty, dry_run, field_manager, field_validation)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1StorageVersionMigration**](V1alpha1StorageVersionMigration.md) |  | [required] |
...
[**crate::models::V1alpha1StorageVersionMigration**](v1alpha1.StorageVersionMigration.md)
...
> crate::models::V1Status delete_collection_storage_version_migration(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, send_initial_events, timeout_seconds, body)
...
> crate::models::V1Status delete_storage_version_migration(name, pretty, dry_run, grace_period_seconds, orphan_dependents, propagation_policy, body)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | name of the StorageVersionMigration | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**grace_period_seconds** | Option<**i32**> | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. |  |
**orphan_dependents** | Option<**bool**> | Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \"orphan\" finalizer will be added to/removed from the object's finalizers list. Either this field or PropagationPolicy may be set, but not both. |  |
...
> crate::models::V1alpha1StorageVersionMigrationList list_storage_version_migration(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
[**crate::models::V1alpha1StorageVersionMigrationList**](v1alpha1.StorageVersionMigrationList.md)
...
> crate::models::V1alpha1StorageVersionMigration patch_storage_version_migration(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1alpha1StorageVersionMigration patch_storage_version_migration_status(name, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1alpha1StorageVersionMigration read_storage_version_migration(name, pretty)
...
> crate::models::V1alpha1StorageVersionMigration read_storage_version_migration_status(name, pretty)
...
> crate::models::V1alpha1StorageVersionMigration replace_storage_version_migration(name, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1alpha1StorageVersionMigration replace_storage_version_migration_status(name, body, pretty, dry_run, field_manager, field_validation)
