...
> crate::models::V1EndpointSlice create_namespaced_endpoint_slice(namespace, body, pretty, dry_run, field_manager, field_validation)
...
> crate::models::V1Status delete_collection_namespaced_endpoint_slice(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, send_initial_events, timeout_seconds, body)
...
> crate::models::V1Status delete_namespaced_endpoint_slice(name, namespace, pretty, dry_run, grace_period_seconds, orphan_dependents, propagation_policy, body)
...
> crate::models::V1EndpointSliceList list_endpoint_slice_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
> crate::models::V1EndpointSliceList list_namespaced_endpoint_slice(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, send_initial_events, timeout_seconds, watch)
...
> crate::models::V1EndpointSlice patch_namespaced_endpoint_slice(name, namespace, body, pretty, dry_run, field_manager, field_validation, force)
...
> crate::models::V1EndpointSlice replace_namespaced_endpoint_slice(name, namespace, body, pretty, dry_run, field_manager, field_validation)
