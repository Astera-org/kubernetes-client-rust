...
pub struct V1alpha3ResourceClaimTemplate {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<crate::models::V1alpha3ResourceClaimTemplateSpec>,
}

impl V1alpha3ResourceClaimTemplate {
    ...
    pub fn new(spec: crate::models::V1alpha3ResourceClaimTemplateSpec) -> V1alpha3ResourceClaimTemplate {
