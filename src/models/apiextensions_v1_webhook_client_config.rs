...
pub struct ApiextensionsV1WebhookClientConfig {
    /// caBundle is a PEM encoded CA bundle which will be used to validate the webhook's server certificate. If unspecified, system trust roots on the apiserver are used.
    #[serde(rename = "caBundle", skip_serializing_if = "Option::is_none")]
    pub ca_bundle: Option<String>,
    #[serde(rename = "service", skip_serializing_if = "Option::is_none")]
    pub service: Option<Box<crate::models::ApiextensionsV1ServiceReference>>,
...
impl ApiextensionsV1WebhookClientConfig {
    /// WebhookClientConfig contains the information to make a TLS connection with the webhook.
    pub fn new() -> ApiextensionsV1WebhookClientConfig {
