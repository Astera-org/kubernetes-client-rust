...
/// V1alpha1AuditAnnotation : AuditAnnotation describes how to produce an audit annotation for an API request.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct V1alpha1AuditAnnotation {
...
impl V1alpha1AuditAnnotation {
    /// AuditAnnotation describes how to produce an audit annotation for an API request.
    pub fn new(key: String, value_expression: String) -> V1alpha1AuditAnnotation {
