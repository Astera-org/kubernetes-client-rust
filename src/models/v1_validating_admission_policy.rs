...
pub struct V1ValidatingAdmissionPolicy {
    ...
    pub spec: Option<Box<crate::models::V1ValidatingAdmissionPolicySpec>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::V1ValidatingAdmissionPolicyStatus>>,
}

impl V1ValidatingAdmissionPolicy {
    /// ValidatingAdmissionPolicy describes the definition of an admission validation policy that accepts or rejects an object without changing it.
    pub fn new() -> V1ValidatingAdmissionPolicy {
