...
pub struct V1ValidatingAdmissionPolicyBindingSpec {
    #[serde(rename = "matchResources", skip_serializing_if = "Option::is_none")]
    pub match_resources: Option<Box<crate::models::V1MatchResources>>,
    #[serde(rename = "paramRef", skip_serializing_if = "Option::is_none")]
    pub param_ref: Option<Box<crate::models::V1ParamRef>>,
...
impl V1ValidatingAdmissionPolicyBindingSpec {
    /// ValidatingAdmissionPolicyBindingSpec is the specification of the ValidatingAdmissionPolicyBinding.
    pub fn new() -> V1ValidatingAdmissionPolicyBindingSpec {
