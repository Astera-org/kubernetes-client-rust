...
pub struct V1alpha3DeviceClass {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<crate::models::V1alpha3DeviceClassSpec>,
}

impl V1alpha3DeviceClass {
    ...
    pub fn new(spec: crate::models::V1alpha3DeviceClassSpec) -> V1alpha3DeviceClass {
        V1alpha3DeviceClass {
            api_version: None,
            kind: None,
            metadata: None,
