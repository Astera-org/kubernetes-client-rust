...
pub struct V1ScaleIoVolumeSource {
    ...
    pub secret_ref: Box<crate::models::V1LocalObjectReference>,
...
impl V1ScaleIoVolumeSource {
    /// ScaleIOVolumeSource represents a persistent ScaleIO volume
    pub fn new(gateway: String, secret_ref: crate::models::V1LocalObjectReference, system: String) -> V1ScaleIoVolumeSource {
