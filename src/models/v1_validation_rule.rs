...
pub struct V1ValidationRule {
    ...
    #[serde(rename = "optionalOldSelf", skip_serializing_if = "Option::is_none")]
...
impl V1ValidationRule {
    /// ValidationRule describes a validation rule written in the CEL expression language.
    pub fn new(rule: String) -> V1ValidationRule {
        V1ValidationRule {
            field_path: None,
            message: None,
