...
pub struct V1alpha3DeviceRequest {
    ...
    #[serde(rename = "allocationMode", skip_serializing_if = "Option::is_none")]
...
impl V1alpha3DeviceRequest {
    ...
    pub fn new(device_class_name: String, name: String) -> V1alpha3DeviceRequest {
