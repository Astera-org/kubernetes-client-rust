...
pub struct V1beta1ValidatingAdmissionPolicyStatus {
    ...
    pub type_checking: Option<Box<crate::models::V1beta1TypeChecking>>,
}

impl V1beta1ValidatingAdmissionPolicyStatus {
    /// ValidatingAdmissionPolicyStatus represents the status of an admission validation policy.
    pub fn new() -> V1beta1ValidatingAdmissionPolicyStatus {
