...
pub struct V1ContainerStatus {
    ...
    #[serde(rename = "allocatedResourcesStatus", skip_serializing_if = "Option::is_none")]
    pub allocated_resources_status: Option<Vec<crate::models::V1ResourceStatus>>,
    ...
    pub user: Option<Box<crate::models::V1ContainerUser>>,
    /// Status of volume mounts.
    #[serde(rename = "volumeMounts", skip_serializing_if = "Option::is_none")]
    pub volume_mounts: Option<Vec<crate::models::V1VolumeMountStatus>>,
}
