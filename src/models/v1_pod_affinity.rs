...
pub struct V1PodAffinity {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<Vec<crate::models::V1WeightedPodAffinityTerm>>,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<Vec<crate::models::V1PodAffinityTerm>>,
}

impl V1PodAffinity {
    /// Pod affinity is a group of inter pod affinity scheduling rules.
    pub fn new() -> V1PodAffinity {
        V1PodAffinity {
