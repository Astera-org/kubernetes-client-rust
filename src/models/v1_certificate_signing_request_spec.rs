...
pub struct V1CertificateSigningRequestSpec {
...
impl V1CertificateSigningRequestSpec {
    /// CertificateSigningRequestSpec contains the certificate request.
    pub fn new(request: String, signer_name: String) -> V1CertificateSigningRequestSpec {
