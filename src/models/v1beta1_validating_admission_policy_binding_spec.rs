...
pub struct V1beta1ValidatingAdmissionPolicyBindingSpec {
    #[serde(rename = "matchResources", skip_serializing_if = "Option::is_none")]
    pub match_resources: Option<Box<crate::models::V1beta1MatchResources>>,
    #[serde(rename = "paramRef", skip_serializing_if = "Option::is_none")]
    pub param_ref: Option<Box<crate::models::V1beta1ParamRef>>,
...
impl V1beta1ValidatingAdmissionPolicyBindingSpec {
    /// ValidatingAdmissionPolicyBindingSpec is the specification of the ValidatingAdmissionPolicyBinding.
    pub fn new() -> V1beta1ValidatingAdmissionPolicyBindingSpec {
