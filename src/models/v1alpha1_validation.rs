...
/// V1alpha1Validation : Validation specifies the CEL expression which is used to apply the validation.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct V1alpha1Validation {
...
impl V1alpha1Validation {
    /// Validation specifies the CEL expression which is used to apply the validation.
    pub fn new(expression: String) -> V1alpha1Validation {
        V1alpha1Validation {
            expression,
            message: None,
