...
pub struct V1ValidatingWebhookConfiguration {
    ...
    pub webhooks: Option<Vec<crate::models::V1ValidatingWebhook>>,
}

impl V1ValidatingWebhookConfiguration {
    /// ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it.
    pub fn new() -> V1ValidatingWebhookConfiguration {
