...
pub struct V1PodDisruptionBudgetStatus {
...
impl V1PodDisruptionBudgetStatus {
    /// PodDisruptionBudgetStatus represents information about the status of a PodDisruptionBudget. Status may trail the actual state of a system.
    pub fn new(current_healthy: i32, desired_healthy: i32, disruptions_allowed: i32, expected_pods: i32) -> V1PodDisruptionBudgetStatus {
