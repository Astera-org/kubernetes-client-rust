...
pub struct V1EndpointSlice {
    ...
    pub endpoints: Vec<crate::models::V1Endpoint>,
    ...
    pub ports: Option<Vec<crate::models::DiscoveryV1EndpointPort>>,
}

impl V1EndpointSlice {
    /// EndpointSlice represents a subset of the endpoints that implement a service. For a given service there may be multiple EndpointSlice objects, selected by labels, which must be joined to produce the full set of endpoints.
    pub fn new(address_type: String, endpoints: Vec<crate::models::V1Endpoint>) -> V1EndpointSlice {
        V1EndpointSlice {
            address_type,
            api_version: None,
            endpoints,
