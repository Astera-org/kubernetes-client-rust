...
pub async fn create_api_service(configuration: &configuration::Configuration, body: crate::models::V1ApiService, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ApiService, Error<CreateApiServiceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/apiregistration.k8s.io/v1/apiservices", local_var_configuration.base_path);
...
pub async fn delete_api_service(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteApiServiceError>> {
    ...
    let local_var_uri_str = format!("{}/apis/apiregistration.k8s.io/v1/apiservices/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
...
pub async fn delete_collection_api_service(configuration: &configuration::Configuration, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionApiServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/apis/apiregistration.k8s.io/v1/", local_var_configuration.base_path);
...
pub async fn list_api_service(configuration: &configuration::Configuration, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ApiServiceList, Error<ListApiServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_api_service(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ApiService, Error<PatchApiServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_api_service_status(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ApiService, Error<PatchApiServiceStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/apiregistration.k8s.io/v1/apiservices/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn replace_api_service(configuration: &configuration::Configuration, name: &str, body: crate::models::V1ApiService, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ApiService, Error<ReplaceApiServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_api_service_status(configuration: &configuration::Configuration, name: &str, body: crate::models::V1ApiService, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ApiService, Error<ReplaceApiServiceStatusError>> {
    let local_var_configuration = configuration;
