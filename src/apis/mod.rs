...
pub mod admissionregistration_v1alpha1_api;
...
pub mod authentication_v1alpha1_api;
...
pub mod flowcontrol_apiserver_v1_api;
pub mod flowcontrol_apiserver_v1beta3_api;
...
pub mod storagemigration_api;
pub mod storagemigration_v1alpha1_api;
pub mod version_api;
