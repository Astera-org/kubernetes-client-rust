...
pub async fn create_namespaced_horizontal_pod_autoscaler(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1HorizontalPodAutoscaler, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1HorizontalPodAutoscaler, Error<CreateNamespacedHorizontalPodAutoscalerError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
...
pub async fn delete_namespaced_horizontal_pod_autoscaler(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedHorizontalPodAutoscalerError>> {
    ...
    let local_var_uri_str = format!("{}/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/apis/autoscaling/v1/", local_var_configuration.base_path);
...
pub async fn list_horizontal_pod_autoscaler_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1HorizontalPodAutoscalerList, Error<ListHorizontalPodAutoscalerForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/autoscaling/v1/horizontalpodautoscalers", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind HorizontalPodAutoscaler
pub async fn list_namespaced_horizontal_pod_autoscaler(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1HorizontalPodAutoscalerList, Error<ListNamespacedHorizontalPodAutoscalerError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_horizontal_pod_autoscaler(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1HorizontalPodAutoscaler, Error<PatchNamespacedHorizontalPodAutoscalerError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_horizontal_pod_autoscaler_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1HorizontalPodAutoscaler, Error<PatchNamespacedHorizontalPodAutoscalerStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn replace_namespaced_horizontal_pod_autoscaler(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1HorizontalPodAutoscaler, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1HorizontalPodAutoscaler, Error<ReplaceNamespacedHorizontalPodAutoscalerError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_horizontal_pod_autoscaler_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1HorizontalPodAutoscaler, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1HorizontalPodAutoscaler, Error<ReplaceNamespacedHorizontalPodAutoscalerStatusError>> {
    let local_var_configuration = configuration;
