...
pub async fn create_custom_resource_definition(configuration: &configuration::Configuration, body: crate::models::V1CustomResourceDefinition, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1CustomResourceDefinition, Error<CreateCustomResourceDefinitionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/apiextensions.k8s.io/v1/customresourcedefinitions", local_var_configuration.base_path);
...
pub async fn delete_collection_custom_resource_definition(configuration: &configuration::Configuration, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionCustomResourceDefinitionError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_custom_resource_definition(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCustomResourceDefinitionError>> {
    ...
    let local_var_uri_str = format!("{}/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/apis/apiextensions.k8s.io/v1/", local_var_configuration.base_path);
...
pub async fn list_custom_resource_definition(configuration: &configuration::Configuration, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1CustomResourceDefinitionList, Error<ListCustomResourceDefinitionError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_custom_resource_definition(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1CustomResourceDefinition, Error<PatchCustomResourceDefinitionError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_custom_resource_definition_status(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1CustomResourceDefinition, Error<PatchCustomResourceDefinitionStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
