...
/// struct for typed errors of method [`delete_collection_namespaced_service`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteCollectionNamespacedServiceError {
    Status401(),
    UnknownValue(serde_json::Value),
}
...
pub async fn connect_delete_namespaced_pod_proxy(configuration: &configuration::Configuration, name: &str, namespace: &str, path: Option<&str>) -> Result<String, Error<ConnectDeleteNamespacedPodProxyError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/proxy", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
...
pub async fn connect_delete_namespaced_pod_proxy_with_path(configuration: &configuration::Configuration, name: &str, namespace: &str, path: &str, path2: Option<&str>) -> Result<String, Error<ConnectDeleteNamespacedPodProxyWithPathError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/proxy/{path}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace), path=crate::apis::urlencode(path));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn connect_delete_namespaced_service_proxy(configuration: &configuration::Configuration, name: &str, namespace: &str, path: Option<&str>) -> Result<String, Error<ConnectDeleteNamespacedServiceProxyError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/services/{name}/proxy", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn connect_delete_namespaced_service_proxy_with_path(configuration: &configuration::Configuration, name: &str, namespace: &str, path: &str, path2: Option<&str>) -> Result<String, Error<ConnectDeleteNamespacedServiceProxyWithPathError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/services/{name}/proxy/{path}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace), path=crate::apis::urlencode(path));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn connect_delete_node_proxy(configuration: &configuration::Configuration, name: &str, path: Option<&str>) -> Result<String, Error<ConnectDeleteNodeProxyError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/nodes/{name}/proxy", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn connect_delete_node_proxy_with_path(configuration: &configuration::Configuration, name: &str, path: &str, path2: Option<&str>) -> Result<String, Error<ConnectDeleteNodeProxyWithPathError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/nodes/{name}/proxy/{path}", local_var_configuration.base_path, name=crate::apis::urlencode(name), path=crate::apis::urlencode(path));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn connect_get_namespaced_pod_attach(configuration: &configuration::Configuration, name: &str, namespace: &str, container: Option<&str>, stderr: Option<bool>, stdin: Option<bool>, stdout: Option<bool>, tty: Option<bool>) -> Result<String, Error<ConnectGetNamespacedPodAttachError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/attach", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
...
pub async fn connect_get_namespaced_pod_exec(configuration: &configuration::Configuration, name: &str, namespace: &str, command: Option<&str>, container: Option<&str>, stderr: Option<bool>, stdin: Option<bool>, stdout: Option<bool>, tty: Option<bool>) -> Result<String, Error<ConnectGetNamespacedPodExecError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/exec", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn connect_get_namespaced_pod_portforward(configuration: &configuration::Configuration, name: &str, namespace: &str, ports: Option<i32>) -> Result<String, Error<ConnectGetNamespacedPodPortforwardError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/portforward", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// create a Namespace
pub async fn create_namespace(configuration: &configuration::Configuration, body: crate::models::V1Namespace, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Namespace, Error<CreateNamespaceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a Binding
pub async fn create_namespaced_binding(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1Binding, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1Binding, Error<CreateNamespacedBindingError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/bindings", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a ConfigMap
pub async fn create_namespaced_config_map(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1ConfigMap, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ConfigMap, Error<CreateNamespacedConfigMapError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/configmaps", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create Endpoints
pub async fn create_namespaced_endpoints(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1Endpoints, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Endpoints, Error<CreateNamespacedEndpointsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/endpoints", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create an Event
pub async fn create_namespaced_event(configuration: &configuration::Configuration, namespace: &str, body: crate::models::CoreV1Event, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::CoreV1Event, Error<CreateNamespacedEventError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/events", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a LimitRange
pub async fn create_namespaced_limit_range(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1LimitRange, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1LimitRange, Error<CreateNamespacedLimitRangeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/limitranges", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_persistent_volume_claim(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1PersistentVolumeClaim, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PersistentVolumeClaim, Error<CreateNamespacedPersistentVolumeClaimError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/persistentvolumeclaims", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a Pod
pub async fn create_namespaced_pod(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1Pod, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Pod, Error<CreateNamespacedPodError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_pod_binding(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Binding, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1Binding, Error<CreateNamespacedPodBindingError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/binding", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_pod_eviction(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Eviction, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1Eviction, Error<CreateNamespacedPodEvictionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/eviction", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_pod_template(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1PodTemplate, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PodTemplate, Error<CreateNamespacedPodTemplateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/podtemplates", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_replication_controller(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1ReplicationController, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ReplicationController, Error<CreateNamespacedReplicationControllerError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/replicationcontrollers", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_resource_quota(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1ResourceQuota, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ResourceQuota, Error<CreateNamespacedResourceQuotaError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/resourcequotas", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a Secret
pub async fn create_namespaced_secret(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1Secret, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Secret, Error<CreateNamespacedSecretError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/secrets", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a Service
pub async fn create_namespaced_service(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1Service, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Service, Error<CreateNamespacedServiceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/services", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_service_account(configuration: &configuration::Configuration, namespace: &str, body: crate::models::V1ServiceAccount, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ServiceAccount, Error<CreateNamespacedServiceAccountError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/serviceaccounts", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_namespaced_service_account_token(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::AuthenticationV1TokenRequest, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::AuthenticationV1TokenRequest, Error<CreateNamespacedServiceAccountTokenError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/serviceaccounts/{name}/token", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// create a Node
pub async fn create_node(configuration: &configuration::Configuration, body: crate::models::V1Node, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Node, Error<CreateNodeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/nodes", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_persistent_volume(configuration: &configuration::Configuration, body: crate::models::V1PersistentVolume, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PersistentVolume, Error<CreatePersistentVolumeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/persistentvolumes", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_collection_namespaced_endpoints(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedEndpointsError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_event(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedEventError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_limit_range(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedLimitRangeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_persistent_volume_claim(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedPersistentVolumeClaimError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_pod(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedPodError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_pod_template(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedPodTemplateError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_replication_controller(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedReplicationControllerError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_resource_quota(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedResourceQuotaError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_secret(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedSecretError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_namespaced_service(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedServiceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteCollectionNamespacedServiceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_collection_namespaced_service_account(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNamespacedServiceAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_node(configuration: &configuration::Configuration, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionNodeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection_persistent_volume(configuration: &configuration::Configuration, pretty: Option<&str>, _continue: Option<&str>, dry_run: Option<&str>, field_selector: Option<&str>, grace_period_seconds: Option<i32>, label_selector: Option<&str>, limit: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteCollectionPersistentVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_namespace(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespaceError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_config_map(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedConfigMapError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/configmaps/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_endpoints(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedEndpointsError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/endpoints/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_event(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedEventError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/events/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_limit_range(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedLimitRangeError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/limitranges/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_persistent_volume_claim(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1PersistentVolumeClaim, Error<DeleteNamespacedPersistentVolumeClaimError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_pod(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Pod, Error<DeleteNamespacedPodError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_pod_template(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1PodTemplate, Error<DeleteNamespacedPodTemplateError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/podtemplates/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_replication_controller(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedReplicationControllerError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/replicationcontrollers/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_resource_quota(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1ResourceQuota, Error<DeleteNamespacedResourceQuotaError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/resourcequotas/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_secret(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNamespacedSecretError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/secrets/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
/// delete a Service
pub async fn delete_namespaced_service(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Service, Error<DeleteNamespacedServiceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/services/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_namespaced_service_account(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1ServiceAccount, Error<DeleteNamespacedServiceAccountError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/serviceaccounts/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_node(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1Status, Error<DeleteNodeError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/nodes/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_persistent_volume(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>, dry_run: Option<&str>, grace_period_seconds: Option<i32>, orphan_dependents: Option<bool>, propagation_policy: Option<&str>, body: Option<crate::models::V1DeleteOptions>) -> Result<crate::models::V1PersistentVolume, Error<DeletePersistentVolumeError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/persistentvolumes/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_component_status(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ComponentStatusList, Error<ListComponentStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/componentstatuses", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_config_map_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ConfigMapList, Error<ListConfigMapForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/configmaps", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_endpoints_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1EndpointsList, Error<ListEndpointsForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/endpoints", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_event_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::CoreV1EventList, Error<ListEventForAllNamespacesError>> {
    let local_var_configuration = configuration;
...
pub async fn list_limit_range_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1LimitRangeList, Error<ListLimitRangeForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/limitranges", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_namespace(configuration: &configuration::Configuration, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1NamespaceList, Error<ListNamespaceError>> {
    let local_var_configuration = configuration;
...
/// list or watch objects of kind ConfigMap
pub async fn list_namespaced_config_map(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ConfigMapList, Error<ListNamespacedConfigMapError>> {
    let local_var_configuration = configuration;
...
/// list or watch objects of kind Endpoints
pub async fn list_namespaced_endpoints(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1EndpointsList, Error<ListNamespacedEndpointsError>> {
    let local_var_configuration = configuration;
...
/// list or watch objects of kind Event
pub async fn list_namespaced_event(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::CoreV1EventList, Error<ListNamespacedEventError>> {
    let local_var_configuration = configuration;
...
/// list or watch objects of kind LimitRange
pub async fn list_namespaced_limit_range(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1LimitRangeList, Error<ListNamespacedLimitRangeError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_persistent_volume_claim(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PersistentVolumeClaimList, Error<ListNamespacedPersistentVolumeClaimError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_pod(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PodList, Error<ListNamespacedPodError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_pod_template(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PodTemplateList, Error<ListNamespacedPodTemplateError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_replication_controller(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ReplicationControllerList, Error<ListNamespacedReplicationControllerError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_resource_quota(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ResourceQuotaList, Error<ListNamespacedResourceQuotaError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_secret(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1SecretList, Error<ListNamespacedSecretError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_service(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ServiceList, Error<ListNamespacedServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn list_namespaced_service_account(configuration: &configuration::Configuration, namespace: &str, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ServiceAccountList, Error<ListNamespacedServiceAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn list_node(configuration: &configuration::Configuration, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1NodeList, Error<ListNodeError>> {
    let local_var_configuration = configuration;
...
pub async fn list_persistent_volume(configuration: &configuration::Configuration, pretty: Option<&str>, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PersistentVolumeList, Error<ListPersistentVolumeError>> {
    let local_var_configuration = configuration;
...
/// list or watch objects of kind PersistentVolumeClaim
pub async fn list_persistent_volume_claim_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PersistentVolumeClaimList, Error<ListPersistentVolumeClaimForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/persistentvolumeclaims", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind Pod
pub async fn list_pod_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PodList, Error<ListPodForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/pods", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind PodTemplate
pub async fn list_pod_template_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1PodTemplateList, Error<ListPodTemplateForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/podtemplates", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind ReplicationController
pub async fn list_replication_controller_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ReplicationControllerList, Error<ListReplicationControllerForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/replicationcontrollers", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind ResourceQuota
pub async fn list_resource_quota_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ResourceQuotaList, Error<ListResourceQuotaForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/resourcequotas", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind Secret
pub async fn list_secret_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1SecretList, Error<ListSecretForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/secrets", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind ServiceAccount
pub async fn list_service_account_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ServiceAccountList, Error<ListServiceAccountForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/serviceaccounts", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// list or watch objects of kind Service
pub async fn list_service_for_all_namespaces(configuration: &configuration::Configuration, allow_watch_bookmarks: Option<bool>, _continue: Option<&str>, field_selector: Option<&str>, label_selector: Option<&str>, limit: Option<i32>, pretty: Option<&str>, resource_version: Option<&str>, resource_version_match: Option<&str>, send_initial_events: Option<bool>, timeout_seconds: Option<i32>, watch: Option<bool>) -> Result<crate::models::V1ServiceList, Error<ListServiceForAllNamespacesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/services", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn patch_namespace(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Namespace, Error<PatchNamespaceError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespace_status(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Namespace, Error<PatchNamespaceStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_config_map(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ConfigMap, Error<PatchNamespacedConfigMapError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_endpoints(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Endpoints, Error<PatchNamespacedEndpointsError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_event(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::CoreV1Event, Error<PatchNamespacedEventError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_limit_range(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1LimitRange, Error<PatchNamespacedLimitRangeError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_persistent_volume_claim(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1PersistentVolumeClaim, Error<PatchNamespacedPersistentVolumeClaimError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_persistent_volume_claim_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1PersistentVolumeClaim, Error<PatchNamespacedPersistentVolumeClaimStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_pod(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Pod, Error<PatchNamespacedPodError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_pod_ephemeralcontainers(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Pod, Error<PatchNamespacedPodEphemeralcontainersError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/ephemeralcontainers", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_pod_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Pod, Error<PatchNamespacedPodStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_pod_template(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1PodTemplate, Error<PatchNamespacedPodTemplateError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_replication_controller(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ReplicationController, Error<PatchNamespacedReplicationControllerError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_replication_controller_scale(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Scale, Error<PatchNamespacedReplicationControllerScaleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/scale", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_replication_controller_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ReplicationController, Error<PatchNamespacedReplicationControllerStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_resource_quota(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ResourceQuota, Error<PatchNamespacedResourceQuotaError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_resource_quota_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ResourceQuota, Error<PatchNamespacedResourceQuotaStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/resourcequotas/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_namespaced_secret(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Secret, Error<PatchNamespacedSecretError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_service(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Service, Error<PatchNamespacedServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_service_account(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1ServiceAccount, Error<PatchNamespacedServiceAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_namespaced_service_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Service, Error<PatchNamespacedServiceStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/services/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_node(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Node, Error<PatchNodeError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_node_status(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1Node, Error<PatchNodeStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/nodes/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn patch_persistent_volume(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1PersistentVolume, Error<PatchPersistentVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_persistent_volume_status(configuration: &configuration::Configuration, name: &str, body: serde_json::Value, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, force: Option<bool>) -> Result<crate::models::V1PersistentVolume, Error<PatchPersistentVolumeStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/persistentvolumes/{name}/status", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn read_component_status(configuration: &configuration::Configuration, name: &str, pretty: Option<&str>) -> Result<crate::models::V1ComponentStatus, Error<ReadComponentStatusError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/componentstatuses/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn read_namespaced_pod_ephemeralcontainers(configuration: &configuration::Configuration, name: &str, namespace: &str, pretty: Option<&str>) -> Result<crate::models::V1Pod, Error<ReadNamespacedPodEphemeralcontainersError>> {
    let local_var_configuration = configuration;
...
pub async fn read_namespaced_pod_log(configuration: &configuration::Configuration, name: &str, namespace: &str, container: Option<&str>, follow: Option<bool>, insecure_skip_tls_verify_backend: Option<bool>, limit_bytes: Option<i32>, pretty: Option<&str>, previous: Option<bool>, since_seconds: Option<i32>, tail_lines: Option<i32>, timestamps: Option<bool>) -> Result<String, Error<ReadNamespacedPodLogError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/namespaces/{namespace}/pods/{name}/log", local_var_configuration.base_path, name=crate::apis::urlencode(name), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn replace_namespace(configuration: &configuration::Configuration, name: &str, body: crate::models::V1Namespace, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Namespace, Error<ReplaceNamespaceError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespace_finalize(configuration: &configuration::Configuration, name: &str, body: crate::models::V1Namespace, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1Namespace, Error<ReplaceNamespaceFinalizeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/namespaces/{name}/finalize", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn replace_namespace_status(configuration: &configuration::Configuration, name: &str, body: crate::models::V1Namespace, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Namespace, Error<ReplaceNamespaceStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_config_map(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ConfigMap, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ConfigMap, Error<ReplaceNamespacedConfigMapError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_endpoints(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Endpoints, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Endpoints, Error<ReplaceNamespacedEndpointsError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_event(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::CoreV1Event, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::CoreV1Event, Error<ReplaceNamespacedEventError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_limit_range(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1LimitRange, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1LimitRange, Error<ReplaceNamespacedLimitRangeError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_pod(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Pod, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Pod, Error<ReplaceNamespacedPodError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_pod_ephemeralcontainers(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Pod, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Pod, Error<ReplaceNamespacedPodEphemeralcontainersError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_pod_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Pod, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Pod, Error<ReplaceNamespacedPodStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_pod_template(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1PodTemplate, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PodTemplate, Error<ReplaceNamespacedPodTemplateError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_replication_controller(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ReplicationController, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ReplicationController, Error<ReplaceNamespacedReplicationControllerError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_replication_controller_scale(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Scale, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Scale, Error<ReplaceNamespacedReplicationControllerScaleError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_replication_controller_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ReplicationController, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ReplicationController, Error<ReplaceNamespacedReplicationControllerStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_resource_quota(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ResourceQuota, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ResourceQuota, Error<ReplaceNamespacedResourceQuotaError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_resource_quota_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ResourceQuota, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ResourceQuota, Error<ReplaceNamespacedResourceQuotaStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_secret(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Secret, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Secret, Error<ReplaceNamespacedSecretError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_service(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Service, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Service, Error<ReplaceNamespacedServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_service_account(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1ServiceAccount, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1ServiceAccount, Error<ReplaceNamespacedServiceAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_namespaced_service_status(configuration: &configuration::Configuration, name: &str, namespace: &str, body: crate::models::V1Service, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Service, Error<ReplaceNamespacedServiceStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_node(configuration: &configuration::Configuration, name: &str, body: crate::models::V1Node, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Node, Error<ReplaceNodeError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_node_status(configuration: &configuration::Configuration, name: &str, body: crate::models::V1Node, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1Node, Error<ReplaceNodeStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_persistent_volume(configuration: &configuration::Configuration, name: &str, body: crate::models::V1PersistentVolume, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PersistentVolume, Error<ReplacePersistentVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn replace_persistent_volume_status(configuration: &configuration::Configuration, name: &str, body: crate::models::V1PersistentVolume, pretty: Option<&str>, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>) -> Result<crate::models::V1PersistentVolume, Error<ReplacePersistentVolumeStatusError>> {
    let local_var_configuration = configuration;
