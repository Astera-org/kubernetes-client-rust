...
pub async fn create_self_subject_review(configuration: &configuration::Configuration, body: crate::models::V1alpha1SelfSubjectReview, dry_run: Option<&str>, field_manager: Option<&str>, field_validation: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1alpha1SelfSubjectReview, Error<CreateSelfSubjectReviewError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/apis/authentication.k8s.io/v1alpha1/selfsubjectreviews", local_var_configuration.base_path);
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/apis/authentication.k8s.io/v1alpha1/", local_var_configuration.base_path);
